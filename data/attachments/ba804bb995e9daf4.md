...
Call log:
  ...
  - waiting for locator('.academy-crash-overlay-bug')
    ...
    at /home/runner/work/QA.GURU_Repo_AcademyBugs/QA.GURU_Repo_AcademyBugs/specs/productsBugs.spec.js:41:14
```
...
```ts
   ...
   27 |       const bugPopupsPage = new BugPopupsPage(page);
   28 |       
   ...
   39 |
   40 |       await expect(bugPopupsPage.crashLayer)
>  41 |             .toContainText(errorsText.crushBugShortText);
      |              ^ Error: expect.toContainText: Error: strict mode violation: locator('.academy-crash-overlay-bug') resolved to 2 elements:
   42 | });
   43 |
   ...
   91 |             .toContainText(errorsText.crushBugLongText);
   92 | });
   93 |
